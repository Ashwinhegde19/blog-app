...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-33wsfbr(y0ocf97_nw$%qx6zx5^oyg41m-f^ynocl0r%5i=#7i')
...
# Use production database when DATABASE_URL is set (on Render)
